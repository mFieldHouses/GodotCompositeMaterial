...
class_name CPMB_MaskTextureConfiguration
...
func get_expression() -> String:
	return "texture(textures[%s], %s).r" % [index, uv.get_expression()]

func _to_string() -> String:
	return "MaskTextureConfiguration:" + resource_scene_unique_id

func get_mapping_key() -> String:
	return "MaskTextureConfiguration"
...
func get_node_name() -> String:
	return "textures/MaskTextureNode"
